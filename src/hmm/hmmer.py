...
# Tabular output iterator
def tblout_iter(iterable):
        """ Iterate through tabular output file

        Args
        iter (iterable)     Iterable which returns a tblout row as a string at
                            each iteration

        Return
        (generator)         Generator returning each line of the tblout table as
